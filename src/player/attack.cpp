...
void Attack::Shoot(Vector2 position, Vector2 direction) {
    ...
    this->projectiles.push_back(Projectile(position, velocity, 3.0f, BLUE));
}

void Attack::Update(float deltaTime, std::vector<std::shared_ptr<Enemy>> enemies, const std::vector<Object>& objects) {
